...
```{r ejemplo-densidad-insumo, echo=FALSE, fig.cap="Relación entre estructuras/viviendas y personas censadas (arriba) y densidad (kernel) de la densidad poblacional por unidad censal (abajo), en la base de entrada."}
...
```{r ejemplo-rhat-hist, echo=FALSE, fig.cap="Estadístico Rhat de todos los parámetros y cantidades generadas de un ajuste real."}
...
```{r ejemplo-trace-sigma, echo=FALSE, fig.cap="Densidad, intervalo y traza posterior de sigma sobre las cuatro cadenas de un ajuste real."}
...
```{r ejemplo-trace-sigmaU, echo=FALSE, fig.cap="Densidad, intervalo y traza posterior de sigmaU sobre las cuatro cadenas de un ajuste real."}
...
```{r ejemplo-acf, echo=FALSE, fig.cap="Autocorrelación de sigma y sigmaU sobre las cuatro cadenas de un ajuste real, calculada sobre las muestras posteriores guardadas."}
...
```{r ejemplo-ppc-densidad, echo=FALSE, fig.cap="Verificación predictiva posterior de la densidad (izquierda) y de los conteos brutos (derecha), salida real del Código de verificación predictiva posterior sobre un ajuste efectivo."}
