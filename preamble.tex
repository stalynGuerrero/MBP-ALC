...
% Capítulo: etiqueta pequeña + regla azul + título grande
% Estilo [display]: sin número gigante, sin riesgo de desborde de margen
\titleformat{\chapter}[display]
  {\normalfont\sffamily\LARGE\bfseries\color{cepalnavy}}
  {\normalsize\sffamily\bfseries\color{cepalblue}%
   \MakeUppercase{\chaptertitlename}\ \thechapter}
  {0.5em}
  {\color{cepalblue}\titlerule[1.5pt]\vspace{0.4em}}
  []
...
% --- Bloques de código numerados (Código X.Y) --------------------
% Reutiliza el entorno "exercise" generado automáticamente por bookdown
% (relabel a "Código " en _bookdown.yml) para dar a los chunks
% destacados una numeración por capítulo, igual que Figura/Tabla.
\AtBeginDocument{
...
% knitr/pandoc no insertan \centering dentro de los entornos figure
% generados por fig.cap + include_graphics; se fuerza aquí para que
% todas las imágenes queden centradas en el PDF.
\usepackage{etoolbox}
